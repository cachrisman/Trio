...
final class G7WatchSensorAdapter: NSObject {
    ...
    /// (Pre-existing; its denominator consumer is replaced by W7's slot accounting — kept for 205,
    /// scheduled for removal post-205. Reset on day rollover and on sensor swap.)
