...
**Last updated:** 2026-05-01 21:16 CET  
...
**Note: The Iteration 1 fix (moving connect-timeout to `didConnect`) was itself superseded by commit 3 (external review finding E4.1), which restored the timeout to `connect()`. The historical record is preserved below, but the final code reflects commit 3, not the Iteration 1 placement.**
...
### v1.3 (2026-05-01)
- Added clarifying note at top of red-team Iteration 1 section: the Iteration 1 connect-timeout placement was superseded by commit 3 (E4.1); the final code uses `connect()` not `didConnect`.
