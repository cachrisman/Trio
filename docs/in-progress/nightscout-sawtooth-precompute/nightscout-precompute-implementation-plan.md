...
**Last updated:** 2026-03-17 10:53 CET  
...
Implementation is in **cgm-remote-monitor** (Nightscout): `bin/sawtooth-precompute.js` (one-shot), `bin/sawtooth-clock.js` (Heroku clock loop), `lib/sawtooth-precompute/*.js`. This section records what was built and what changed after each review.
