...
| | A | **Pending** | Build verification (`BUILD_CURRENT=1 SKIP_RELEASE=1`), patch generation, patch application test. |
| | B | **Not started** | Better Stack Extract Metrics configuration (4 rules). Blocked on Phase A logs flowing. |
| | C | **Not started** | Dashboard panels (4 panels). Blocked on Phase B extraction rules. |
